...
class GetContactAPI:
    def __init__(self,anticaptcha_key='',manual_captcha_decode=False,proxies=None):
        self.updater = UpdateConfig()
        self.requester = Requester(self.updater.get_config(),anticaptcha_key=anticaptcha_key,manual_captcha_decode=manual_captcha_decode,proxies=proxies)
